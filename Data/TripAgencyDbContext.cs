...
namespace CW_10_s31552.Data;

public partial class TripAgencyDbContext : DbContext
{
    public TripAgencyDbContext()
    {
    }

    public TripAgencyDbContext(DbContextOptions<TripAgencyDbContext> options)
        : base(options)
    {
    }
    ...
    {
        modelBuilder.HasDefaultSchema("s31552");
